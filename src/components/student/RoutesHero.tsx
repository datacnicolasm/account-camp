    ...
    <FadeIn duration={0.4} y={8} delay={0.05}>
      <div className="relative isolate overflow-hidden rounded-2xl border border-white/10 px-6 py-8 shadow-lg md:px-8 md:py-10">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #0b1f3a 0%, #0d2a48 35%, #13465c 70%, rgba(34, 211, 238, 0.15) 100%)",
        ...
        {/* Soft blur accent in corner - kept inside bounds to avoid edge bleed */}
        <div className="absolute right-4 top-4 h-24 w-24 rounded-full bg-[#22d3ee]/20 blur-2xl" />

        <div className="relative flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
          <div className="min-w-0 flex-1 space-y-4">
            <span className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-medium text-white/95">
              De cero a perfil profesional
            </span>
            <h1 className="text-2xl font-bold tracking-tight text-white sm:text-3xl">
              Rutas profesionales
            </h1>
            <p className="max-w-xl text-sm leading-relaxed text-white/80 sm:text-base">
              Sigue una ruta diseñada para llevarte paso a paso a un perfil.
              Completa cursos cortos y mide tu avance.
            </p>
          </div>
          ...
          <div className="hidden shrink-0 md:flex md:items-center md:justify-center">
            <div className="relative flex h-28 w-28 items-center justify-center">
              ...
              <div className="relative flex h-16 w-16 items-center justify-center rounded-xl bg-[#22d3ee]/20 ring-1 ring-[#22d3ee]/30">
                <Layers className="h-8 w-8 text-[#22d3ee]" aria-hidden="true" />
              </div>
            </div>
          </div>
        </div>
